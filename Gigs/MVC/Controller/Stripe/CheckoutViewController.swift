...
class CheckoutViewController: UIViewController, STPPaymentContextDelegate {
    ...
    let stripePublishableKey = "pk_test_7i2xb5Jy3ALoAkQW6ZoCFwDx"
    
    // 2) Next, optionally, to have this demo save your user's payment details, head to
    // https://github.com/stripe/example-ios-backend , click "Deploy to Heroku", and follow
    // the instructions (don't worry, it's free). Replace nil on the line below with your
    // Heroku URL (it looks like https://blazing-sunrise-1234.herokuapp.com ).
    let backendBaseURL: String? = "https://iosgigs.herokuapp.com/"
    ...
    let companyName = "Gigs"
//    var paymentCurrency = ""
    
    var myStrTransactionId = String()
    ...
    init(product: String, price: Int, paymentCurrency: String, orderId : String, settings: Settings) {
...
//        price = self.numberFormatter.string(from: NSNumber(value: Float(price)/100))!
        
        self.myOrderId = orderId
...
//        self.navigationItem.title = "Gigs"
//
...
////        self.totalRow.detail = self.numberFormatter.string(from: NSNumber(value: self.paymentContext.paymentAmount))!
//        self.totalRow.detail = self.numberFormatter.string(from: NSNumber(value: Float(self.paymentContext.paymentAmount)/100))!
...
//        }
    ...
    func paymentContext(_ paymentContext: STPPaymentContext, didCreatePaymentResult paymentResult: STPPaymentResult, completion: @escaping STPErrorBlock) {
        myStrTransactionId = paymentResult.source.stripeID
...
//        }
    ...
    //MARK: - Call Stripe Success Api
    
    func callStripeSuccessApi() {
        ...
        dictParameters[K_PAYPAL_ID] = myStrTransactionId
        dictParameters[K_ITEM_NUMBER] = myOrderId
        
        HTTPMANAGER.callPostApi(strUrl: WEB_SERVICE_URL+CASE_PAYPAL_SUCCESS_SERVICE, dictParameters: dictParameters, sucessBlock: { (response) in

//        HTTPMANAGER.paypalSuccessRequest(item_number:myOrderId,paypal_id:myStrTransactionId, sucessblock: {response in
            ...
            if aIntResponseCode == RESPONSE_CODE_200 {
                ...
                HELPER.hideLoadingAnimation()
                    HELPER.showDefaultAlertViewController(aViewController: self, alertTitle: APP_NAME, aStrMessage: "Success")
